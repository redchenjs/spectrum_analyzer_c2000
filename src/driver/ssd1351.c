...
#define SSD1351_GPIO_PIN_DC 123U

#define SSD1351_PIN_SET()   do {\
                                    GPIO_setPadConfig(SSD1351_GPIO_PIN_DC,  GPIO_PIN_TYPE_STD);\
                                    GPIO_setDirectionMode(SSD1351_GPIO_PIN_DC,  GPIO_DIR_MODE_OUT);\
                            } while (0)

#define SSD1351_DC_SET()    GPIO_writePin(SSD1351_GPIO_PIN_DC, 1);
